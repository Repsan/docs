...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/respanai/respan-example-projects/main/python/dev-tools/claude-code/respan_hook.py" -OutFile "$env:USERPROFILE\.claude\hooks\respan_hook.py"
```
</CodeGroup>
...
The full source code is available on GitHub: [Respan/respan-example-projects/claude_code](https://github.com/respanai/respan-example-projects/tree/main/python/dev-tools/claude-code)
