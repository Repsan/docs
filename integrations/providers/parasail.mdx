---
title: "Parasail"
description: "Use your own Parasail credits through Respan"
---
...
<CardGroup cols={1}>
  <Card title="Get Parasail API key" icon="key" href="https://parasail.ai/">
    Get your Parasail API key from the Parasail platform to start using Parasail models through Respan.
  </Card>
</CardGroup>
...
### Via code
Add `customer_credentials` parameter in your [request body](/apis/develop/gateway/chat-completions) to use your own Parasail credits.
