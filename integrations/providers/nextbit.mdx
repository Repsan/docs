---
title: "Nextbit"
description: "Use your own Nextbit credits through Respan"
---
...
<CardGroup cols={1}>
  <Card title="Get Nextbit API key" icon="key" href="https://nextbit.ai/">
    Get your Nextbit API key from the Nextbit platform to start using Nextbit models through Respan.
  </Card>
</CardGroup>
...
### Via code
Add `customer_credentials` parameter in your [request body](/apis/develop/gateway/chat-completions) to use your own Nextbit credits.
