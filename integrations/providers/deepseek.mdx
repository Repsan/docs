---
title: "DeepSeek"
description: "Use your own DeepSeek credits through Respan"
---
...
<CardGroup cols={1}>
  <Card title="Get DeepSeek API key" icon="key" href="https://platform.deepseek.com/api_keys">
    Get your DeepSeek API key from the DeepSeek Platform to start using DeepSeek models through Respan.
  </Card>
</CardGroup>
...
### Via code
Add `customer_credentials` parameter in your [request body](/apis/develop/gateway/chat-completions) to use your own DeepSeek credits.
