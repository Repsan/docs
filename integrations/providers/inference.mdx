---
title: "Inference"
description: "Use your own Inference credits through Respan"
---
...
<CardGroup cols={1}>
  <Card title="Get Inference API key" icon="key" href="https://inference.ai/">
    Get your Inference API key from the Inference platform to start using Inference models through Respan.
  </Card>
</CardGroup>
...
<Step title="Add your Inference credentials.">
Add your Inference API key in the providers page.
</Step>
</Steps>

### Via code
Add `customer_credentials` parameter in your [request body](/apis/develop/gateway/chat-completions) to use your own Inference credits.
