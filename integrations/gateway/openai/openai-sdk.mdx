...
[OpenAI](https://platform.openai.com/) SDK provides the most robust integration method for accessing multiple model providers. 
...
A variable in one prompt can reference another prompt. The child prompt is rendered first and injected into the parent. See [Prompt composition](/documentation/features/prompt-management/manage-prompts#prompt-composition) for setup details.
