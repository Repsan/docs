...
api: "POST https://api.respan.ai/api/prompts/<prompt_id>/versions/"
---
...
Get the `prompt_id` from the [prompts endpoint](/apis/develop/prompts/create-prompts).
...
<ParamField body="tools" type="array">
    The list of tools to use for the prompt version. Check out [function calling](/documentation/features/gateway/advanced-configuration#function-calling) for more information.
    <Accordion title="Example">
```json
{
"tools": [
