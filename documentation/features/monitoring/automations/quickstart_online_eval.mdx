...
Once your condition and [evaluator](https://docs.respan.ai/documentation/features/evals/evaluators) are ready, navigate to [Automations](https://platform.respan.ai/platform/monitors) and create a new **automation**.
